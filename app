...
STOPWORDS_EXTRA = set(STOPWORDS) | {
    ...
    "the", "a", "an", "and", "or", "but", "of", "to", "for", "on",
    "at", "by", "with", "from", "as", "in", "into", "onto", "upon",
    "within", "without", "among", "between", "against", "through",
    # Verbs (common / auxiliary)
    "is", "are", "was", "were", "be", "been", "being",
    "has", "have", "had", "do", "does", "did",
    "will", "would", "could", "should", "may", "might", "shall",
    "says", "say", "said", "get", "got", "make", "made", "take",
    "know", "think", "see", "go", "going", "come", "came",
    # Pronouns
    "it", "its", "he", "she", "they", "we", "i", "you",
    "his", "her", "their", "our", "my", "your", "him", "them", "us",
    # Determiners / quantifiers
    "this", "that", "these", "those", "all", "each", "every",
    "some", "any", "no", "both", "few", "more", "most", "other",
    "such", "same", "own",
    # Adverbs & filler
    "not", "now", "just", "also", "even", "still", "yet", "already",
    "here", "there", "then", "when", "where", "while", "how",
    "very", "so", "too", "only", "well", "back",
    # Numbers / generic counters
    "one", "two", "three", "first", "second", "third",
    # News-specific boilerplate
    "new", "after", "amid", "over", "up", "out", "about",
    "what", "who", "why", "report", "reports", "live",
    # Generic nouns with no analytical value
    "point", "points", "part", "parts", "way", "ways",
    "time", "times", "year", "years", "day", "days",
    "week", "weeks", "month", "months",
    "thing", "things", "people", "person",
    "man", "woman", "men", "women",
    "country", "world", "place", "area",
    "case", "cases", "number", "group", "groups",
    "side", "end", "use", "used", "using",
    "call", "calls", "called", "show", "shows",
    "told", "tell", "result", "results",
    "around", "across", "another", "s",
}
